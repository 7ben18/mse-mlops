...
def predict(image_bytes: bytes) -> dict:
    ...
    return {
        ...
        "probabilities": {name: round(p, 4) for name, p in zip(_class_names, probs)},
    }


# --- Stub hooks for future integration ---

def log_prediction_to_mlflow(image_id: str, prediction: dict) -> None:
    pass  # TODO: plug in MLflow client


def notify_curation_pipeline(image_id: str, label: str) -> None:
    pass  # TODO: trigger retraining pipeline
